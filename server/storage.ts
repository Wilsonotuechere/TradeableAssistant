...
export interface IStorage {
  ...
  setMarketStats(stats: MarketStats): Promise<void>;
...
export class MemStorage implements IStorage {
  ...
  private _marketStats: MarketStats | null = null;
  ...
  async getMarketStats(): Promise<MarketStats> {
    if (this._marketStats) {
      return this._marketStats;
    }
  ...
  async setMarketStats(stats: MarketStats): Promise<void> {
    // Store market stats temporarily in memory
    this._marketStats = stats;
  }
